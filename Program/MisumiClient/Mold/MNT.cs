...
namespace Misumi_Client.Mold
{
    public partial class MNT : Form
    {
        ...
        private void MNT_Load(object sender, EventArgs e)
        {
            ...
            this.PicJ.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/J.jpg");
            this.PicJL.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/JL.jpg");
            this.PicD.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/D.jpg");
            this.PicJB.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/JB.jpg");
            this.PicJT.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/JT.jpg");
            this.PicJY.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/JY.jpg");
            this.PicJH.Image = SpecialComm.LoadUrlImage(WebUrl + PicPath + "MNT05/JH.jpg");
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "MNT", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
