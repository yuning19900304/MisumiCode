...
{
    public partial class S27_29K : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S27_29K(ModelObject model)
        {
            Model = model;
        ...
        private void S27_29K_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("_", "□");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "27-29K", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic3K_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("_K", "") + strShape1;
        }
    }
}
