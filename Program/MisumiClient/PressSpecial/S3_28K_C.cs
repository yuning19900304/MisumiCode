...
{
    public partial class S3_28K_C : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_28K_C(ModelObject model)
        {
            Model = model;
        ...
        private void S3_28K_C_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "3-28K-C", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
