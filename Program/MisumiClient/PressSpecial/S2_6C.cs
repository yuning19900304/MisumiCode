...
{
    public partial class S2_6C : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_6C(ModelObject model)
        {
            Model = model;
        ...
        private void S2_6C_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-6)", "□");
            this.Pic2C.LoadAsync(WebUrl + PicPath + "S2_4C/2C.jpg");
            this.Pic3C.LoadAsync(WebUrl + PicPath + "S2_4C/3C.jpg");
            this.Pic4C.LoadAsync(WebUrl + PicPath + "S2_4C/4C.jpg");
            this.Pic5C.LoadAsync(WebUrl + PicPath + "S2_4C/5C.jpg");
            this.Pic6C.LoadAsync(WebUrl + PicPath + "S2_4C/6C.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-6C", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2C_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-6)C", "") + strShape1;
        }
    }
}
