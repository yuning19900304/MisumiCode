...
{
    public partial class S2_5B : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_5B(ModelObject model)
        {
            Model = model;
        ...
        private void S2_5B_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-5)", "□");
            this.Pic2B.LoadAsync(WebUrl + PicPath + "S2_5B/2B.jpg");
            this.Pic3B.LoadAsync(WebUrl + PicPath + "S2_5B/3B.jpg");
            this.Pic4B.LoadAsync(WebUrl + PicPath + "S2_5B/4B.jpg");
            this.Pic5B.LoadAsync(WebUrl + PicPath + "S2_5B/5B.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-5B", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2B_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-5)B", "") + strShape1;
        }
    }
}
