...
{
    public partial class S3_28K_CP : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_28K_CP(ModelObject model)
        {
            Model = model;
        ...
        private void S3_28K_CP_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "S3-28K-CP", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
