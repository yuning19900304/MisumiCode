...
{
    public partial class S3_29K : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_29K(ModelObject model)
        {
            Model = model;
        ...
        private void S3_29K_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3-29)", "□");
            ...
            this.Pic23K.LoadAsync(WebUrl + PicPath + "S27_29K/23K.jpg");
            this.Pic25K.LoadAsync(WebUrl + PicPath + "S27_29K/25K.jpg");
            this.Pic27K.LoadAsync(WebUrl + PicPath + "S27_29K/27K.jpg");
            this.Pic28K.LoadAsync(WebUrl + PicPath + "S27_29K/28K.jpg");
            this.Pic29K.LoadAsync(WebUrl + PicPath + "S27_29K/29K.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "S3_29K", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic3K_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3-29)K", "") + strShape1;
        }
    }
}
