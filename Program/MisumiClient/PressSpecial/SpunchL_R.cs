...
{
    public partial class SpunchL_R : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public SpunchL_R(ModelObject model)
        {
            Model = model;
        ...
        private void SpunchL_R_Load(object sender, EventArgs e)
        {
            ...
            this.Pic7.LoadAsync(WebUrl + PicPath + "SPunch/punchL7.jpg");
            this.Pic8.LoadAsync(WebUrl + PicPath + "SPunch/punchL8.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "punchL_R", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            Model.E_CatalogType = Model.ModelType;//把统合Web类型，重新赋值，后退
            this.Hide();
