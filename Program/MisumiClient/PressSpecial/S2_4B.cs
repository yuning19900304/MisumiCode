...
{
    public partial class S2_4B : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_4B(ModelObject model)
        {
            Model = model;
        ...
        private void S2_4B_Load(object sender, EventArgs e)
        {
            ...
            this.Pic2B.LoadAsync(WebUrl + PicPath + "S2_4B/2B.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-4B", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2B_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-4)B", "") + strShape1;
        }
    }
}
