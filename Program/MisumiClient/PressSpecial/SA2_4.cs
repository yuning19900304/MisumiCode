...
{
    public partial class SA2_4 : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public SA2_4(ModelObject model)
        {
            Model = model;
        ...
        private void SA2_4_Load(object sender, EventArgs e)
        {
            ...
            this.Pic2A.LoadAsync(WebUrl + PicPath + "SA2_4/2A.jpg");
            this.Pic3A.LoadAsync(WebUrl + PicPath + "SA2_4/3A.jpg");
            this.Pic4A.LoadAsync(WebUrl + PicPath + "SA2_4/4A.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "A2-4", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
