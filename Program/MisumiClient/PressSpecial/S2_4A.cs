...
{
    public partial class S2_4A : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_4A(ModelObject model)
        {
            Model = model;
        ...
        private void S2_4A_Load(object sender, EventArgs e)
        {
            ...
            this.Pic2A.LoadAsync(WebUrl + PicPath + "S2_4A/2A.jpg");
            this.Pic3A.LoadAsync(WebUrl + PicPath + "S2_4A/3A.jpg");
            this.Pic4A.LoadAsync(WebUrl + PicPath + "S2_4A/4A.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-4A", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2A_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-4)A", "") + strShape1;
        }
    }
}
