...
{
    public partial class S2_5D : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_5D(ModelObject model)
        {
            Model = model;
        ...
        private void S2_5D_Load(object sender, EventArgs e)
        {
            ...
            this.Pic5D.LoadAsync(WebUrl + PicPath + "S2_4D/5D.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-5D", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2D_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-5)D", "") + strShape1;
        }
    }
}
