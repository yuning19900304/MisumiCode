...
{
    public partial class S3_4B : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_4B(ModelObject model)
        {
            Model = model;
        ...
        private void S3_4B_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3-4)", "□");
            this.Pic3B.LoadAsync(WebUrl + PicPath + "S2_4B/3B.jpg");
            this.Pic4B.LoadAsync(WebUrl + PicPath + "S2_4B/4B.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "3-4B", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2B_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3-4)B", "") + strShape1;
        }
    }
}
