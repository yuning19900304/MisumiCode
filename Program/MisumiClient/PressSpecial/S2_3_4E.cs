...
{
    public partial class S2_3_4E : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_3_4E(ModelObject model)
        {
            Model = model;
        ...
        private void S2_3_4E_Load(object sender, EventArgs e)
        {
            ...
            this.Pic2E.LoadAsync(WebUrl + PicPath + "S2_3_4E/2E.jpg");
            this.Pic3E.LoadAsync(WebUrl + PicPath + "S2_3_4E/3E.jpg");
            this.Pic4E.LoadAsync(WebUrl + PicPath + "S2_3_4E/4E.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-4E", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2E_Click(object sender, EventArgs e)
        {
            PictureBox ShapePic = (PictureBox)sender;
            SpecialComm.ShowPanel(ShapePic, panelShape1);
            strShape1 = ShapePic.Tag.ToString();
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-4)E", "") + strShape1;
        }
    }
}
