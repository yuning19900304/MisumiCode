...
{
    public partial class S3_4A : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_4A(ModelObject model)
        {
            Model = model;
        ...
        private void S3_4A_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3･4)", "□").Replace("(3-4)", "□");
            this.Pic3A.LoadAsync(WebUrl + PicPath + "S3_4A/3A.jpg");
            this.Pic4A.LoadAsync(WebUrl + PicPath + "S3_4A/4A.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "3_4A", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic3A_Click(object sender, EventArgs e)
        {
            PictureBox ShapePic = (PictureBox)sender;
            SpecialComm.ShowPanel(ShapePic, panelShape1);
            strShape1 = ShapePic.Tag.ToString();
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3･4)A", strShape1).Replace("(3-4)A", strShape1);
        }
    }
}
