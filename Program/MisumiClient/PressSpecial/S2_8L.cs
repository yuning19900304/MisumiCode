...
{
    public partial class S2_8L : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_8L(ModelObject model)
        {
            Model = model;
        ...
        private void S2_8L_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-8)", "□").Replace("(2-7)", "□").Replace("_", "□");
            this.Pic2L.LoadAsync(WebUrl + PicPath + "S2_8L/2L.jpg");
            this.Pic3L.LoadAsync(WebUrl + PicPath + "S2_8L/3L.jpg");
            this.Pic4L.LoadAsync(WebUrl + PicPath + "S2_8L/4L.jpg");
            this.Pic5L.LoadAsync(WebUrl + PicPath + "S2_8L/5L.jpg");
            this.Pic7L.LoadAsync(WebUrl + PicPath + "S2_8L/7L.jpg");
            this.Pic8L.LoadAsync(WebUrl + PicPath + "S2_8L/8L.jpg");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "2-8L", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic2L_Click(object sender, EventArgs e)
        {
            PictureBox ShapePic = (PictureBox)sender;
            SpecialComm.ShowPanel(ShapePic, panelShape1);
            strShape1 = ShapePic.Tag.ToString();
            this.txtModelType.Text = Model.E_CatalogType.Replace("(2-8)L", "").Replace("(2-7)L", "").Replace("-L", "") + strShape1;
        }
    }
}
