...
{
    public partial class S2_4E : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S2_4E(ModelObject model)
        {
            Model = model;
        ...
        private void S2_4E_Load(object sender, EventArgs e)
        {
            ...
            this.Pic2E.LoadAsync(WebUrl + PicPath + "S2_4E/2E.jpg");
            this.Pic3E.LoadAsync(WebUrl + PicPath + "S2_4E/3E.jpg");
            this.Pic4E.LoadAsync(WebUrl + PicPath + "S2_4E/4E.jpg");
