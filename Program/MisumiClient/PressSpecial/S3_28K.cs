...
{
    public partial class S3_28K : Form
    {
        public string WebUrl = "";
        public string strShape1 = "";
        ModelObject Model;
        LanguageManager LM;
        public S3_28K(ModelObject model)
        {
            Model = model;
        ...
        private void S3_28K_Load(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3～28)", "□").Replace("(3-28)", "□");
        ...
        private void btn_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LM.SetLanguage("SpecialMsg"), "3-28K", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Pic3K_Click(object sender, EventArgs e)
        {
            ...
            this.txtModelType.Text = Model.E_CatalogType.Replace("(3～28)K", "").Replace("(3-28)K", "") + strShape1;
        }
    }
}
